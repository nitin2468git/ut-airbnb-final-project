...
I fit four models of increasing capacity. I picked them to span the interpretability-to-flexibility spectrum that the second half of my research question is about.
...
The full pipeline uses scikit-learn (Pedregosa et al., 2011), XGBoost (Chen & Guestrin, 2016), PyTorch (Paszke et al., 2019), and shap (Lundberg & Lee, 2017), with pandas for data handling. All of it runs on a free-tier Google Colab CPU runtime in under five minutes.
